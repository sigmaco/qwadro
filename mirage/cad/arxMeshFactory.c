...
_ARX afxError ArxCleanUpMeshFactory(arxMeshFactory2* mfac)
{
    afxError err = { 0 };
    AFX_ASSERT(mfac);
    return err;
...
_ARX afxError ArxSetUpMeshFactory(arxMeshFactory2* mfac, afxUnit triCnt, afxUnit mtlCnt, afxUnit biasCnt)
{
    afxError err = { 0 };
    AFX_ASSERT(mfac);
    *mfac = (arxMeshFactory2) { 0 };
    return err;
}

_ARX afxError ArxAddTriangles(arxMeshFactory2* mfac, afxUnit mtlIdx, afxUnit triCnt, afxV3d vertices[][3])
{
    afxError err = { 0 };
    AFX_ASSERT(vertices);
    AFX_ASSERT(mfac);
...
_ARX afxError ArxAddMaterial(arxMeshFactory2* mfac, afxString const* name, afxUnit* mtlIdx)
{
    afxError err = { 0 };
    AFX_ASSERT(mfac);
    return err;
...
_ARX afxError ArxRebuildTriangleNormals(arxMeshFactory2* mfac, afxUnit baseTriIdx, afxUnit cnt)
{
    afxError err = { 0 };
    AFX_ASSERT(mfac);
...
_ARX afxError ArxRebuildTriangleTangents(arxMeshFactory2* mfac, afxUnit baseTriIdx, afxUnit cnt)
{
    afxError err = { 0 };
    AFX_ASSERT(mfac);
    AFX_ASSERT_RANGE(mfac->triCnt, baseTriIdx, cnt);
...
_ARX afxError ArxRebuildTriangleSkins(arxMeshFactory2* mfac, afxUnit baseTriIdx, afxUnit cnt)
{
    afxError err = { 0 };
    AFX_ASSERT(mfac);
    AFX_ASSERT_RANGE(mfac->triCnt, baseTriIdx, cnt);
...
_ARX afxError ArxBuildParallelepipedMesh(arxScenario scio, afxV3d whd, afxReal slantX, afxReal slantY, afxV3d const pivot, arxMesh* mesh)
{
    ...
    arxMesh msh;
    ArxBuildMeshes(scio, 1, NIL, &mshb, &msh);

    ArxFormatVertexAttribute(msh, 0, avxFormat_RGB32f, arxVertexFlag_POSITIONAL | arxVertexFlag_SPATIAL | arxVertexFlag_ATV);
    ArxFormatVertexAttribute(msh, 1, avxFormat_RGB32f, arxVertexFlag_NORMALIZED | arxVertexFlag_LTM);
    ArxFormatVertexAttribute(msh, 2, avxFormat_RG32f, arxVertexFlag_NORMALIZED | arxVertexFlag_LTM);
...
_ARX afxError ArxBuildDomeMesh2(arxScenario scio, afxReal radius, afxUnit stacks, afxUnit slices, afxBool inv, afxV3d const pivot, arxMesh* mesh)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SCIO, 1, &scio);
    ...
    if (strip)
    {
        ...
        AfxAssembleMeshTopology(scio, 1, &mshtb, &msht);
...
_ARX afxError ArxBuildCapsuleMesh(arxScenario scio, afxReal radius, afxReal height, afxUnit stacks, afxUnit slices, afxUnit cylinderSlices, afxBool inv, afxV3d const pivot, arxMesh* mesh)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SCIO, 1, &scio);
...
_ARX afxError ArxBuildPlaneMesh(arxScenario scio, afxUnit gridSizeX, afxUnit gridSizeY, afxReal width, afxReal height, afxV3d const pivot, arxMesh* mesh)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SCIO, 1, &scio);
...
_ARX afxError ArxBuildSphereMesh(arxScenario scio, afxReal radius, afxUnit stacks, afxUnit slices, afxBool inv, afxV3d const pivot, arxMesh* mesh)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SCIO, 1, &scio);
...
_ARX afxError ArxBuildTorusMesh(arxScenario scio, afxReal innerRadius, afxReal outerRadius, afxUnit sides, afxUnit rings, arxMesh* mesh)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SCIO, 1, &scio);
    AFX_ASSERT(mesh);
...
_ARX afxError ArxBuildCylinderMesh(arxScenario scio, afxReal radius1, afxReal radius2, afxReal len, afxUnit slices, afxUnit stacks, arxMesh* mesh)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SCIO, 1, &scio);
    AFX_ASSERT(mesh);
...
_ARX afxError ArxBuildBoxMesh(arxScenario scio, afxV3d const whd, afxV3d const pivot, afxUnit secCnt, arxMesh* mesh)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SCIO, 1, &scio);
    AFX_ASSERT(mesh);
    ...
    // Tangents are predefined for TBN (Tangent-Bitangent-Normal) shading (e.g., normal mapping).
    ...
    ArxFormatVertexAttribute(msh, 0, avxFormat_RGB32f, arxVertexFlag_POSITIONAL | arxVertexFlag_SPATIAL | arxVertexFlag_ATV);
    ArxFormatVertexAttribute(msh, 1, avxFormat_RGB32f, arxVertexFlag_NORMALIZED | arxVertexFlag_LTM);
    ArxFormatVertexAttribute(msh, 2, avxFormat_RGB32f, arxVertexFlag_NORMALIZED | arxVertexFlag_LTM);
    ArxFormatVertexAttribute(msh, 3, avxFormat_RG32f, arxVertexFlag_NORMALIZED);
...
_ARX afxError ArxBuildGridMesh(arxScenario scio, afxUnit rows, afxUnit layers, afxReal width, afxReal depth, afxV3d const pivot, arxMesh* mesh)
{
    ...
    ArxFormatVertexAttribute(msh, 0, avxFormat_RGB32f, arxVertexFlag_ATV);
    ArxFormatVertexAttribute(msh, 1, avxFormat_RGB32f, arxVertexFlag_LTM);
    ArxFormatVertexAttribute(msh, 2, avxFormat_RGB32f, arxVertexFlag_LTM);
    ArxFormatVertexAttribute(msh, 3, avxFormat_RG32f, NIL);
    afxV3d* pos = ArxAccessVertexData(msh, 0, 0, 0);
    afxV3d* nrm = ArxAccessVertexData(msh, 1, 0, 0);
