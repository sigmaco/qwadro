...
#include "qwadro/vga/dma/avxFormat.h"
...
AVX afxString const* AfxGetShaderName
(
    avxShader shd, 
    afxUnit prog
);
...
AVX afxBool AvxDoesShaderHavePushConstants
(
    avxShader shd, 
    afxUnit crate
);

AVX afxError AvxCompileShader
(
    avxShader shd, 
    afxString const* crate, 
    afxString const* code
);

AVX afxError AvxCompileShaderFromDisk
(
    avxShader shd, 
    afxString const* crate, 
    afxUri const* uri
...
AVX afxError AvxRecompileShader
(
    avxShader shd, 
    afxUnit crate, 
    afxString const* code
...
AVX afxError AvxRecompileShaderFromDisk
(
    avxShader shd, 
    afxUnit crate, 
    afxUri const* uri
...
AVX afxBool AvxFindShaderCrate
(
    avxShader shd, 
    afxUnit cnt, 
