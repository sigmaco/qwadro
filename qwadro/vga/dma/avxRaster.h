...
AVX afxError AvxAcquireExorasters
(
    // The system which will host the new acquired rasters.
    afxDrawSystem dsys,
...
AVX afxError AvxAcquireSubrasters
(
    // The system which will host the new acquired rasters.
    afxDrawSystem dsys,
...
AVX afxDrawSystem AvxGetRasterSystem
(
    avxRaster ras
);
...
/*
    The AvxGetRasterInfo() function provides detailed information about the raster, 
    storing the result in the provided avxRasterInfo structure.
*/

AVX void AvxGetRasterInfo
(
    avxRaster ras, 
...
AVXINL afxError AvxGetSubrasterInfo
(
    avxRaster ras, 
    avxSubrasterInfo* sub
);

AVXINL afxError AvxGetExorasterInfo
(
    avxRaster ras, 
