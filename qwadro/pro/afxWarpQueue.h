...
#ifndef ACX_WARP_QUEUE_H
#define ACX_WARP_QUEUE_H
...
AFX_DEFINE_STRUCT(acxSubmission)
{
    ...
    // An array of step contexts that represent the individual warping commands or operations to be executed. 
    // Each afxMixContext could contain specific information about a set of warping commands, such as commands 
...
ACX afxWarpDevice    AcxGetWarpQueueDevice(afxWarpQueue sque);
ACX afxWarpSystem    AcxGetWarpQueueSystem(afxWarpQueue sque);

#endif//ACX_WARP_QUEUE_H
