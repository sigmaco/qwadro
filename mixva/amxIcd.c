...
_AMX afxString const amxSignature = AFX_STRING(
    "      ::::::::  :::       :::     :::     :::::::::  :::::::::   ::::::::      \n"
    "     :+:    :+: :+:       :+:   :+: :+:   :+:    :+: :+:    :+: :+:    :+:     \n"
    "     +:+    +:+ +:+       +:+  +:+   +:+  +:+    +:+ +:+    +:+ +:+    +:+     \n"
    "     +#+    +:+ +#+  +:+  +#+ +#++:++#++: +#+    +:+ +#++:++#:  +#+    +:+     \n"
...
_AMX afxClass const* _AmxIcdGetAsiClass(afxModule icd)
{
    afxError err = { 0 };
...
_AMX afxError _AmxIcdRegisterAsis(afxModule icd, afxUnit cnt, _amxMdevReg const infos[], afxDevice devices[])
{
    ...
    afxClass* cls = (afxClass*)_AmxIcdGetAsiClass(icd);
    AFX_ASSERT_CLASS(cls, afxFcc_MDEV);
...
_AMX afxError _AmxIcdRegisterAsi(afxModule icd, afxClassConfig const* asiCls)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_MDLE, 1, &icd);
    AFX_ASSERT(asiCls);
