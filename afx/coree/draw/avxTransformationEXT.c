...
_AVX afxError AvxCmdChangeFillModeEXT(afxDrawContext dctx, avxFillMode mode)
{
    afxError err = { 0 };
...
_AFX afxError AvxCmdBeginTransformFeedbackEXT
(
    afxDrawContext dctx,
    afxUnit firstCntBuf,
    afxUnit cntBufCnt,
...
_AFX afxError AvxCmdEndTransformFeedbackEXT
(
    afxDrawContext dctx,
    afxUnit firstCntBuf,
    afxUnit cntBufCnt,
...
_AFX afxError AvxCmdBeginQueryIndexedEXT
(
    afxDrawContext dctx,
    avxQueryPool qryp,
    afxUnit query,
...
_AFX afxError AvxCmdEndQueryIndexedEXT
(
    afxDrawContext dctx,
    avxQueryPool qryp,
    afxUnit query,
...
_AFX afxError AvxCmdBindTransformFeedbackBuffersEXT
(
    afxDrawContext dctx,
    afxUnit first,
    afxUnit cnt,
...
_AFX afxError AvxCmdDrawIndirectByteCountEXT
(
    afxDrawContext dctx,
    afxUnit instCnt,
    afxUnit firstInst,
...
_AVX afxError AvxCmdDrawMeshTasksEXT
(
    afxDrawContext dctx,
...
_AVX afxError AvxCmdDrawMeshTasksIndirectEXT
(
    afxDrawContext dctx,
...
_AVX afxError AvxCmdDrawMeshTasksIndirectCountEXT
(
    afxDrawContext dctx,
    // The buffer containing draw parameters.
    avxBuffer buf,
