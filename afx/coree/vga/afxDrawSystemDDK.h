...
#include "gfx/avxPipelineDDK.h"
#include "gfx/avxQueryPoolDDK.h"
#include "gfx/avxShaderDDK.h"
#include "gfx/avxLigatureDDK.h"
#include "gfx/avxVertexInputDDK.h"
#include "gfx/avxSamplerDDK.h"
#include "gfx/avxCanvasDDK.h"
#include "afxSurfaceDDK.h"
#include "dma/avxRasterDDK.h"
#include "dma/avxBufferDDK.h"
...
AFX_DEFINE_STRUCT(_avxDsysDdi)
{
    ...
    afxError(*cfgPipCb)(afxDrawSystem, avxPipelineConfig*);
    afxError(*acqPipCb)(afxDrawSystem, afxUnit cnt, avxPipelineConfig const[], avxPipeline[]);
