...
_AFXINL void AfxAtomicStore32(afxAtom32* dst, afxInt32 value) { InterlockedExchange(dst, value); }
_AFXINL afxInt32 AfxAtomicLoad32(afxAtom32* src) { return *src; }
_AFXINL afxInt32 AfxAtomicInc32(afxAtom32* val) { return InterlockedExchangeAdd(val, 1) + 1; }
_AFXINL afxInt32 AfxAtomicDec32(afxAtom32* val) { return InterlockedExchangeAdd(val, -1) - 1; }
_AFXINL afxInt32 AfxAtomicExchange32(afxAtom32* dst, afxInt32 value) { return InterlockedExchange(dst, value); }
_AFXINL afxInt32 AfxAtomicAdd32(afxAtom32* dst, afxInt32 value) { return InterlockedExchangeAdd(dst, value) + value; }
_AFXINL afxInt32 AfxAtomicSub32(afxAtom32* dst, afxInt32 value) { return InterlockedExchangeAdd(dst, -value) - value; }
_AFXINL afxInt32 AfxAtomicAnd32(afxAtom32* dst, afxInt32 value) { return _InterlockedAnd(dst, value) & value; }
_AFXINL afxInt32 AfxAtomicOr32(afxAtom32* dst, afxInt32 value) { return _InterlockedOr(dst, value) | value; }
_AFXINL afxBool AfxAtomicCas32(afxAtom32* dst, afxInt32* expected, afxInt32 proposed) { return InterlockedCompareExchange(dst, proposed, *expected) == *expected ? 1 : 0; }

#ifdef AFX_OS_WIN64
_AFXINL afxInt64 AfxAtomicLoad64(afxAtom64* src) { return *src; }
#else
_AFXINL afxInt64 AfxAtomicLoad64(afxAtom64* src) { return InterlockedCompareExchange64(src, 0, 0); }
#endif

_AFXINL void AfxAtomicStore64(afxAtom64* dst, afxInt64 value) { InterlockedExchange64(dst, value); }
_AFXINL afxInt64 AfxAtomicInc64(afxAtom64* val) { return InterlockedExchangeAdd64(val, 1) + 1; }
_AFXINL afxInt64 AfxAtomicDec64(afxAtom64* val) { return InterlockedExchangeAdd64(val, -1) - 1; }
_AFXINL afxInt64 AfxAtomicExchange64(afxAtom64* dst, afxInt64 value) { return InterlockedExchange64(dst, value); }
_AFXINL afxInt64 AfxAtomicAdd64(afxAtom64* dst, afxInt64 value) { return InterlockedExchangeAdd64(dst, value) + value; }
_AFXINL afxInt64 AfxAtomicSub64(afxAtom64* dst, afxInt64 value) { return InterlockedExchangeAdd64(dst, -value) - value; }
_AFXINL afxInt64 AfxAtomicAnd64(afxAtom64* dst, afxInt64 value) { return InterlockedAnd64(dst, value) & value; }
_AFXINL afxInt64 AfxAtomicOr64(afxAtom64* dst, afxInt64 value) { return InterlockedOr64(dst, value) | value; }
_AFXINL afxBool AfxAtomicCas64(afxAtom64* dst, afxInt64* expected, afxInt64 proposed) { afxInt64 exp = *expected;  return InterlockedCompareExchange64(dst, proposed, exp) == exp ? 1 : 0; }

_AFXINL void* AfxAtomicLoadPtr(afxAtomPtr* src) { return (void*)*src; }

#ifdef AFX_OS_WIN64
_AFXINL void AfxAtomicStorePtr(afxAtomPtr* dst, void* value) { InterlockedExchangePointer((volatile PVOID*)dst, value); }
_AFXINL void* AfxAtomicExchangePtr(afxAtomPtr* dst, void* value) { return InterlockedExchangePointer((volatile PVOID*)dst, value); }
_AFXINL afxBool AfxAtomicCasPtr(afxAtomPtr* dst, void** expected, void* proposed) { return InterlockedCompareExchangePointer((volatile PVOID*)dst, proposed, *expected) == *expected ? 1 : 0; }
#else
_AFXINL void AfxAtomicStorePtr(afxAtomPtr* dst, void* value) { InterlockedExchangePointer((void**)dst, value); }
_AFXINL void* AfxAtomicExchangePtr(afxAtomPtr* dst, void* value) { return InterlockedExchangePointer((void**)dst, value); }
_AFXINL afxBool AfxAtomicCasPtr(afxAtomPtr* dst, void** expected, void* proposed) { return InterlockedCompareExchangePointer((void**)dst, proposed, *expected) == *expected ? 1 : 0; }
#endif

#else // we assume it will be Linux

_AFXINL afxInt32 AfxAtomicLoad32(afxAtom32* pSrc) { int32_t ret; __atomic_load((int32_t*)pSrc, &ret, __ATOMIC_ACQUIRE); return ret; }
_AFXINL void AfxAtomicStore32(afxAtom32* pDest, afxInt32 value) { __atomic_store((int32_t*)pDest, &value, __ATOMIC_SEQ_CST); }
_AFXINL afxInt32 AfxAtomicInc32(afxAtom32* pValue) { return __sync_add_and_fetch((int32_t*)pValue, 1); }
_AFXINL afxInt32 AfxAtomicDec32(afxAtom32* pValue) { return __sync_sub_and_fetch((int32_t*)pValue, 1); }
_AFXINL afxInt32 AfxAtomicExchange32(afxAtom32* pDest, afxInt32 value) { return __sync_lock_test_and_set((int32_t*)pDest, value); }
_AFXINL afxInt32 AfxAtomicAdd32(afxAtom32* pDest, afxInt32 value) { return __sync_add_and_fetch((int32_t*)pDest, value); }
_AFXINL afxInt32 AfxAtomicSub32(afxAtom32* pDest, afxInt32 value) { return __sync_sub_and_fetch((int32_t*)pDest, value); }
_AFXINL afxInt32 AfxAtomicAnd32(afxAtom32* pDest, afxInt32 value) { return __sync_and_and_fetch((int32_t*)pDest, value); }
_AFXINL afxInt32 AfxAtomicOr32(afxAtom32* pDest, afxInt32 value) { return __sync_or_and_fetch((int32_t*)pDest, value); }
_AFXINL afxBool AfxAtomicCas32(afxAtom32* pDest, afxInt32* expected, afxInt32 proposed) { return __sync_bool_compare_and_swap((int32_t*)pDest, *expected, proposed); }

#if defined( AFX_ISA_X86 ) || ( defined( AFX_ISA_ARM ) && ( AFX_ISA_ARM <= 7 ) )
_AFXINL afxInt64 AfxAtomicLoad64(afxAtom64* pSrc) { return __sync_val_compare_and_swap(pSrc, 0, 0); }
_AFXINL void AfxAtomicStore64(afxAtom64* pDest, afxInt64 value) { int64_t tmp; do { tmp = *pDest; } while (__sync_val_compare_and_swap(pDest, tmp, value) != tmp); }
#else
_AFXINL afxInt64 AfxAtomicLoad64(afxAtom64* pSrc) { afxInt64 ret; __atomic_load((int64_t*)pSrc, &ret, __ATOMIC_ACQUIRE); return ret; }
_AFXINL void AfxAtomicStore64(afxAtom64* pDest, afxInt64 value) { __atomic_store((int64_t*)pDest, &value, __ATOMIC_SEQ_CST); }
#endif

_AFXINL afxInt64 AfxAtomicInc64(afxAtom64* pValue) { return __sync_add_and_fetch((int64_t*)pValue, 1); }
_AFXINL afxInt64 AfxAtomicDec64(afxAtom64* pValue) { return __sync_sub_and_fetch((int64_t*)pValue, 1); }
_AFXINL afxInt64 AfxAtomicExchange64(afxAtom64* pDest, afxInt64 value) { return __sync_lock_test_and_set((int64_t*)pDest, value); }
_AFXINL afxInt64 AfxAtomicAdd64(afxAtom64* pDest, afxInt64 value) { return __sync_add_and_fetch((int64_t*)pDest, value); }
_AFXINL afxInt64 AfxAtomicSub64(afxAtom64* pDest, afxInt64 value) { return __sync_sub_and_fetch((int64_t*)pDest, value); }
_AFXINL afxInt64 AfxAtomicAnd64(afxAtom64* pDest, afxInt64 value) { return __sync_and_and_fetch((int64_t*)pDest, value); }
_AFXINL afxInt64 AfxAtomicOr64(afxAtom64* pDest, afxInt64 value) { return __sync_or_and_fetch((int64_t*)pDest, value); }
_AFXINL afxBool AfxAtomicCas64(afxAtom64* pDest, afxInt64* expected, afxInt64 proposed) { return __sync_bool_compare_and_swap((int64_t*)pDest, *expected, proposed); }

_AFXINL void* AfxAtomicLoadPtr(afxAtomPtr* pSrc) { size_t ret; __atomic_load((size_t*)pSrc, &ret, __ATOMIC_ACQUIRE); return (void*)ret; }
_AFXINL void AfxAtomicStorePtr(afxAtomPtr* pDest, void* value) { __atomic_store((size_t*)pDest, (size_t*)&value, __ATOMIC_SEQ_CST); }
_AFXINL void* AfxAtomicExchangePtr(afxAtomPtr* pDest, void* value) { return (void*)__sync_lock_test_and_set((void**)pDest, value); }
_AFXINL afxBool AfxAtomicCasPtr(afxAtomPtr* pDest, void** expected, void* proposed) { return __sync_bool_compare_and_swap((void**)pDest, *expected, proposed); }
...
_AFX afxInt32 AfxAtomicLoad32_(const volatile afxInt32* obj, afxMemoryOrder order)
{
#if USE_ATOMIC_WORKAROUND_MSVC
    afxInt32 result = 0;
...
_AFX afxInt64 AfxAtomicLoad64_(const volatile afxInt64* obj, afxMemoryOrder order)
{
#if USE_ATOMIC_WORKAROUND_MSVC
    afxInt64 result = 0;
...
_AFX void AfxAtomicStore32_(volatile afxInt32* obj, afxInt32 value, afxMemoryOrder order)
{
#if USE_ATOMIC_WORKAROUND_MSVC
    switch (order) {
    case afxMemoryOrder_RELAXED:
...
_AFX void AfxAtomicStore64_(volatile afxInt64* obj, afxInt64 value, afxMemoryOrder order)
{
#if USE_ATOMIC_WORKAROUND_MSVC
    switch (order) {
    case afxMemoryOrder_RELAXED:
...
_AFX afxInt32 AfxAtomicExchange32_(volatile afxInt32* obj, afxInt32 value, afxMemoryOrder order)
{
#if USE_ATOMIC_WORKAROUND_MSVC
    long old_value = 0;
...
_AFX afxInt64 AfxAtomicExchange64_(volatile afxInt64* obj, afxInt64 value, afxMemoryOrder order)
{
#if USE_ATOMIC_WORKAROUND_MSVC
