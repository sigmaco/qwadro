...
_AFX afxError AfxBeginObjectAcquisition(afxClass* cls, afxUnit cnt, afxObject objects[], void const* udd[])
{
    afxError err = { 0 };
    AFX_ASSERT(cls->fcc == afxFcc_CLS);
    AFX_ASSERT(cnt);
...
_AFX afxError AfxEndObjectAcquisition(afxClass* cls, afxUnit cnt, afxObject objects[], void const* udd[])
{
    afxError err = { 0 };
    AFX_ASSERT(cls->fcc == afxFcc_CLS);
    AFX_ASSERT(cnt);
