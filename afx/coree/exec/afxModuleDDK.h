...
AFX_DEFINE_STRUCT(_afxIcdModuleData)
{
    ...
    union
    {
        ...
        struct
        {
            ...
            afxClass sshCls;
            afxClass envCls;
            afxError(*getDpyClsc)(afxModule icd, afxString const* tool, afxClassConfig* clsc);
            afxError(*getDoutClsc)(afxDrawSystem dsys, afxString const* tool, afxClassConfig* clsc);
        };

        struct
        {
            afxLink acx; // ICD attachment for ACX implementations
            afxClass cdevCls;
            afxClass ssysCls;
        };
        ...
        struct
        {
            afxLink arx; // ICD attachment for ARX implementations
            afxClass rdevCls;
            afxClass scioCls;
            afxClass simCls;
        };
        ...
        struct
        {
            afxLink akx; // ICD attachment for ARX implementations
            afxClass kdevCls;
            afxClass ksimCls;
        };
    };
