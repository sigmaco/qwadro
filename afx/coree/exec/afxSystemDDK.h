...
AFX_OBJECT(afxSystem)
{
    ...
    // acx
    afxBool             acxDisabled;
    afxModule           e2comboDll;
    afxClass            cdevCls;
    afxChain            acxIcdChain;
    afxError            (*acxIoctl)(afxSystem, afxModule, afxUnit, void*);
...
AFX afxClassConfig const _AFX_XSS_CLASS_CONFIG;
...
AFX afxClass const*     _AfxSysGetXssClass(afxSystem sys);
...
AFX afxError _AfxScanIcdManifests(afxSystem sys, afxString const* platform, afxManifest const* sysIni);


AFX afxUri const* _AfxGetSystemDirectory(afxUri* dst);
AFX afxString const* _AfxGetSystemDirectoryString(afxString* dst);

AFX afxUri const* _AfxGetPwd(afxUri* dst);
AFX afxString const* _AfxGetPwdString(afxString* dst);
