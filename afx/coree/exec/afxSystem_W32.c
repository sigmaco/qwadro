...
AFX afxBool _AfxLoadAndAttachIcd(void* udd, afxUnit diskId, afxUnit endpointIdx, afxUri const* path, afxUri const* osPath);
        ...
        else
        {
            ...
            else
            {
...

                {
                    ...
                    AfxFindFiles(&cfg->shell.uri, afxFileFlag_R, (void*)_AfxLoadAndAttachIcd, sys);
