...
AFX_DEFINE_STRUCT(arxViewConstants) // frame
{
    afxM4d  p;
    afxM4d  ip;
    afxM4d  pv;
...
AFX_DEFINE_STRUCT(arxShaderConstants) // pass
{
    afxV3d wirecolor;
};

AFX_DEFINE_STRUCT(arxMaterialConstants)
{
...
AFX_OBJECT(arxRenderer)
{
    ...
    struct
    {
        arxViewConstants    viewConstants;
        arxShaderConstants  shaderConstants;
        arxMaterialConstants materialConstants;
