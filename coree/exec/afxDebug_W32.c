...
_AFXINL afxError AfxOutputDebugString(afxHere const src, afxUnit type, afxUnit severity, afxUnit id, afxString const* msg)
{
    return 0;
}

_AFXINL afxError AfxPushDebugRegion(afxHere const src, afxUnit id, afxString const* label)
{
    return 0;
}

_AFXINL afxError AfxPopDebugRegion(afxHere const src)
{
    return 0;
}
