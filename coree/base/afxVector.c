...
_AFXINL void AfxV2dFill(afxV2d v, afxReal value)
{
    afxError err = { 0 };
    AFX_ASSERT(v);
    v[0] = value;
...
_AFXINL void AfxV3dFill(afxV3d v, afxReal value)
{
    afxError err = { 0 };
    AFX_ASSERT(v);
    v[0] = value;
...
_AFXINL void AfxV4dFill(afxV4d v, afxReal value)
{
    afxError err = { 0 };
    AFX_ASSERT(v);
    v[0] = value;
...
_AFXINL void AfxV4dReset(afxV4d v)
{
    afxError err = { 0 };
    AFX_ASSERT(v);
...
_AFXINL afxBool AfxV2dIsEqual(afxV2d const v, afxV2d const other)
{
    ...
    AFX_ASSERT(v);
    AFX_ASSERT(other);
    return AFX_WORD32(v[0] == other[0], v[1] == other[1], 0, 0);
}
...
_AFXINL afxBool AfxV3dIsEqual(afxV3d const v, afxV3d const other)
{
    ...
    AFX_ASSERT(v);
    AFX_ASSERT(other);
    return AFX_WORD32(v[0] == other[0], v[1] == other[1], v[2] == other[2], 0);
}
...
_AFXINL afxBool AfxV4dIsEqual(afxV4d const v, afxV4d const other)
{
    ...
    AFX_ASSERT(v);
    AFX_ASSERT(other);
    return AFX_WORD32(v[0] == other[0], v[1] == other[1], v[2] == other[2], v[3] == other[3]);
}
...
_AFXINL afxBool AfxV2dIsInfinite(afxV2d const v)
{
    afxError err = { 0 };
    AFX_ASSERT(v);
    return  (AfxIsInfinite(v[0]) ? 0xFFFFFFFFU : 0) | 
            (AfxIsInfinite(v[1]) ? 0xFFFFFFFFU : 0);
}
...
_AFXINL afxBool AfxV3dIsInfinite(afxV3d const v)
{
    ...
    return  (AfxIsInfinite(v[0]) ? 0xFFFFFFFFU : 0) | 
            (AfxIsInfinite(v[1]) ? 0xFFFFFFFFU : 0) | 
            (AfxIsInfinite(v[2]) ? 0xFFFFFFFFU : 0);
}
...
_AFXINL afxBool AfxV4dIsInfinite(afxV4d const v)
{
    ...
    return  (AfxIsInfinite(v[0]) ? 0xFFFFFFFFU : 0) | 
            (AfxIsInfinite(v[1]) ? 0xFFFFFFFFU : 0) | 
            (AfxIsInfinite(v[2]) ? 0xFFFFFFFFU : 0) | 
            (AfxIsInfinite(v[3]) ? 0xFFFFFFFFU : 0);
}
