...
_AVX afxBool AvxGetShaderCrate(avxShader shd, afxUnit unit, void** slot)
{
    afxError err = { 0 };
...
_AVX afxBool AvxFindShaderCrate(avxShader shd, afxUnit cnt, afxString const names[], afxUnit units[])
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
    AFX_ASSERT(names);
...
_AVX afxBool AvxDoesShaderHavePushConstants(avxShader shd, afxUnit crate)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
...
_AVX afxError AvxSerializeShader(avxShader shd, afxUnit crate, afxStream ios)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
...
_AVX afxError AvxDumpShaderCode(avxShader shd, afxUnit crate, afxArray* arr)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
...
_AVX afxError AvxPrintShader(avxShader shd, afxUnit crate, afxUri const *uri)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
    ...
    if (AvxSerializeShader(shd, crate, file))
        AfxThrowError();
...
_AVX afxUnit AvxQueryShaderIns(avxShader shd, afxUnit crate, afxUnit first, afxUnit cnt, avxShaderIoChannel channels[])
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
...
_AVX afxUnit AvxQueryShaderOuts(avxShader shd, afxUnit crate, afxUnit first, afxUnit cnt, avxShaderIoChannel channels[])
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
...
_AVX afxUnit AvxQueryShaderInterfaces(avxShader shd, afxUnit crate, afxUnit first, afxUnit cnt, avxShaderResource rsrc[])
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
...
_AVX avxShaderType AvxGetShaderStage(avxShader shd, afxUnit crate)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
...
_AVX afxString const* AfxGetShaderName(avxShader shd, afxUnit crate)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
...
_AVX afxError AvxRecompileShader(avxShader shd, afxUnit crate, afxString const* code)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
...
_AVX afxError AvxRecompileShaderFromDisk(avxShader shd, afxUnit crate, afxUri const* uri)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
    ...
    else
    {
        ...
        else
        {
            ...
            if (AvxRecompileShader(shd, crate, &fCodeS))
                AfxThrowError();
...
_AVX afxError AvxCompileShader(avxShader shd, afxString const* crate, afxString const* code)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
    ...
    if (!AvxFindShaderCrate(shd, 1, crate, &slotId))
    {
        ...
        AfxMakeString32(&slot->name, crate);
        //slot->tag;
        //slot->udd;
    }
    else
    {
        if (!AvxGetShaderCrate(shd, slotId, (void**)&slot))
        {
            AfxThrowError();
            return err;
        }
...
_AVX afxError AvxCompileShaderFromDisk(avxShader shd, afxString const* crate, afxUri const* uri)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_SHD, 1, &shd);
...
_AVX afxError AvxAcquireShaders(afxDrawSystem dsys, afxUnit cnt, afxUri const urls[], avxShader codebases[])
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_DSYS, 1, &dsys);
