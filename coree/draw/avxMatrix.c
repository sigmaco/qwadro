...
_AVXINL void AfxComputeLookToMatrix(afxM4d m, afxV3d const eye, afxV3d const dir, afxV3d const up, afxBool nonRhcs)
{
    afxError err = { 0 };
    AFX_ASSERT(m);
...
_AVXINL void AfxComputeLookAtMatrix(afxM4d m, afxV3d const eye, afxV3d const target, afxV3d const up, afxBool nonRhcs)
{
    afxError err = { 0 };
    AFX_ASSERT(m);
    AFX_ASSERT(eye);
    ...
    if (nonRhcs) // Direct3D
    {
        ...
        AfxComputeLookToMatrix(m, eye, dir, up, nonRhcs);
    }
    else // OpenGL/Vulkan/Qwadro
    {
...
_AVXINL void AfxComputeOrthographicMatrix(afxM4d m, afxV2d const extent, afxReal near, afxReal far, afxBool nonRhcs, avxClipSpaceDepth clip)
{
    afxError err = { 0 };
    AFX_ASSERT(m);
    AFX_ASSERT(extent);
    ...
    else
    {
        ...
        {
            AfxComputeBasicOrthographicMatrix(m, extent[0] / extent[1], 1, far, nonRhcs, clip);
        }
        else
        {
            AfxThrowError();
...
_AVXINL void AfxComputeOffcenterOrthographicMatrix(afxM4d m, afxReal left, afxReal right, afxReal bottom, afxReal top, afxReal near, afxReal far, afxBool nonRhcs, avxClipSpaceDepth clip)
{
    afxError err = { 0 };
    AFX_ASSERT(m);
    AfxM4dReset(m);
...
_AVXINL void AfxComputeBoundingOrthographicMatrix(afxM4d m, afxBox const aabb, afxBool nonRhcs, avxClipSpaceDepth clip)
{
    ...
    // OpenGL
    AfxComputeOffcenterOrthographicMatrix(m, aabb.max[0], aabb.min[0], aabb.max[1], aabb.min[1], -aabb.min[2], -aabb.max[2], nonRhcs, clip);
}

_AVXINL void AfxComputeBasicOrthographicMatrix(afxM4d m, afxReal aspectRatio, afxReal scale, afxReal range, afxBool nonRhcs, avxClipSpaceDepth clip)
{
    ...
    if (aspectRatio >= 1.f)
    {
        AfxComputeOffcenterOrthographicMatrix(m, -scale * aspectRatio, scale * aspectRatio, -scale, scale, -scale - range, scale + range, nonRhcs, clip);
    }
    else
    {
        aspectRatio = 1.f / aspectRatio;
        AfxComputeOffcenterOrthographicMatrix(m, -scale, scale, -scale / aspectRatio, scale / aspectRatio, -scale - range, scale + range, nonRhcs, clip);
    }
}

// PERSPECTIVE /////////////////////////////////////////////////////////////////

_AVXINL void AfxComputePerspectiveMatrix(afxM4d m, afxV2d const extent, afxReal near, afxReal far, afxBool nonRhcs, avxClipSpaceDepth clip)
{
    afxError err = { 0 };
    AFX_ASSERT(m);
    AFX_ASSERT(extent);
...
_AVXINL void AfxComputeFovPerspectiveMatrix(afxM4d m, afxReal fovY, afxReal aspectRatio, afxReal near, afxReal far, afxBool nonRhcs, avxClipSpaceDepth clip)
{
    afxError err = { 0 };
    AFX_ASSERT(m);
...
_AVXINL void AfxComputeOffcenterPerspectiveMatrix(afxM4d m, afxReal left, afxReal right, afxReal bottom, afxReal top, afxReal near, afxReal far, afxBool nonRhcs, avxClipSpaceDepth clip)
{
    afxError err = { 0 };
    AFX_ASSERT(m);
    AFX_ASSERT(!AfxRealIsEqual(right, left, 0.00001f));
...
_AVXINL void AfxComputeBasicPerspectiveMatrix(afxM4d m, afxReal aspectRatio, afxReal range, afxBool nonRhcs, avxClipSpaceDepth clip)
{
    afxError err = { 0 };
    AFX_ASSERT(m);
    AfxComputeFovPerspectiveMatrix(m, AFX_PI / 4.f, aspectRatio, 0.01f, range, nonRhcs, clip);
}
