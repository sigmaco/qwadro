...
_AVX afxError AvxCmdCopyBuffer(afxDrawContext dctx, avxBuffer dst, afxUnit opCnt, avxBufferCopy const ops[], avxBuffer src)
{
    afxError err = { 0 };
...
_AVX afxError AvxCmdFillBuffer(afxDrawContext dctx, avxBuffer buf, afxSize offset, afxUnit range, afxUnit value)
{
    afxError err = { 0 };
    // dctx must be a valid afxDrawContext handle.
    AFX_ASSERT_OBJECTS(afxFcc_DCTX, 1, &dctx);
...
_AVX afxError AvxCmdClearBuffer(afxDrawContext dctx, avxBuffer buf, afxSize offset, afxUnit range)
{
    afxError err = { 0 };
    // dctx must be a valid afxDrawContext handle.
    AFX_ASSERT_OBJECTS(afxFcc_DCTX, 1, &dctx);
...
_AVX afxError AvxCmdUpdateBuffer(afxDrawContext dctx, avxBuffer buf, afxSize offset, afxUnit range, void const* src)
{
    afxError err = { 0 };
    // dctx must be a valid afxDrawContext handle.
    AFX_ASSERT_OBJECTS(afxFcc_DCTX, 1, &dctx);
...
_AVX afxError AvxCmdPackRaster(afxDrawContext dctx, avxRaster ras, afxUnit opCnt, avxRasterIo const ops[], avxBuffer buf)
{
    afxError err = { 0 };
    // dctx must be a valid afxDrawContext handle.
    AFX_ASSERT_OBJECTS(afxFcc_DCTX, 1, &dctx);
...
_AVX afxError AvxCmdUnpackRaster(afxDrawContext dctx, avxRaster ras, afxUnit opCnt, avxRasterIo const ops[], avxBuffer buf)
{
    afxError err = { 0 };
    // dctx must be a valid afxDrawContext handle.
    AFX_ASSERT_OBJECTS(afxFcc_DCTX, 1, &dctx);
...
_AVX afxError AvxCmdCopyRaster(afxDrawContext dctx, avxRaster dst, afxUnit opCnt, avxRasterCopy const ops[], avxRaster src)
{
    afxError err = { 0 };
    // dctx must be a valid afxDrawContext handle.
    AFX_ASSERT_OBJECTS(afxFcc_DCTX, 1, &dctx);
...
_AVX afxError AvxCmdResolveRaster(afxDrawContext dctx, avxRaster dst, afxUnit opCnt, avxRasterCopy const ops[], avxRaster src)
{
    afxError err = { 0 };
    // dctx must be a valid afxDrawContext handle.
    AFX_ASSERT_OBJECTS(afxFcc_DCTX, 1, &dctx);
...
_AVX afxError AvxCmdBlitRaster(afxDrawContext dctx, avxRaster dst, afxUnit opCnt, avxRasterBlit const ops[], avxRaster src, avxTexelFilter flt)
{
    afxError err = { 0 };
    // dctx must be a valid afxDrawContext handle.
    AFX_ASSERT_OBJECTS(afxFcc_DCTX, 1, &dctx);
...
_AVX afxError AvxCmdClearRaster(afxDrawContext dctx, avxRaster ras, avxClearValue const* value, afxUnit baseLod, afxUnit lodCnt, afxUnit baseLayer, afxUnit layerCnt)
{
    afxError err = { 0 };
    // dctx must be a valid afxDrawContext handle.
    AFX_ASSERT_OBJECTS(afxFcc_DCTX, 1, &dctx);
...
_AVX afxError AvxCmdRegenerateMipmapsSIGMA(afxDrawContext dctx, afxFlags flags, afxUnit rasCnt, avxRaster rasters[])
{
    afxError err = { 0 };
    // dctx must be a valid afxDrawContext handle.
    AFX_ASSERT_OBJECTS(afxFcc_DCTX, 1, &dctx);
