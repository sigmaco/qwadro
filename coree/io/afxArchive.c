...
_AFX afxError _AfxArcDtorCb(afxArchive arc)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_ARC, 1, &arc);
...
_AFX afxError _AfxArcCtorCb(afxArchive arc, void** args, afxUnit invokeNo)
{
    afxError err = { 0 };
    AFX_ASSERT_OBJECTS(afxFcc_ARC, 1, &arc);
...
_AFX afxClassConfig const _AFX_CLASS_CONFIG_ARC =
{
    .fcc = afxFcc_ARC,
    .name = "Archive",
    .desc = "Disk Storage Archive",
    .fixedSiz = sizeof(AFX_OBJECT(afxArchive)),
    .ctor = (void*)_AfxArcCtorCb,
    .dtor = (void*)_AfxArcDtorCb
};

////////////////////////////////////////////////////////////////////////////////

_AFX afxError AfxOpenArchive(afxUri const* uri, afxFileFlags const flags, afxArchive* archive)
{
    afxError err = { 0 };
    AFX_ASSERT(uri);
